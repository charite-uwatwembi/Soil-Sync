...
const Footer: React.FC<FooterProps> = ({ onPageChange }) => {
  ...
  return (
    <footer className="bg-gray-900 dark:bg-black text-white transition-colors duration-200 border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          {/* Quick Links Section */}
          <div>
            <h4 className="font-semibold text-white mb-3 text-sm">{t('footer.quickLinks')}</h4>
            <ul className="space-y-2">
              <li>
                <button onClick={scrollToTop} className="text-gray-400 hover:text-green-400 transition-colors text-sm">
                  {t('footer.home')}
                </button>
              </li>
              <li>
                <button onClick={() => scrollToSection('features')} className="text-gray-400 hover:text-green-400 transition-colors text-sm">
                  {t('footer.features')}
                </button>
              </li>
              <li>
                <button onClick={() => scrollToSection('pricing')} className="text-gray-400 hover:text-green-400 transition-colors text-sm">
                  {t('footer.pricing')}
                </button>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-4 pt-3 text-center">
          <p className="text-gray-400 text-sm">
            © 2025 Soil-Sync. {t('footer.allRightsReserved')}
          </p>
        </div>
      </div>
    </footer>
